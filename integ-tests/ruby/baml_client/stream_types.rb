...
module BamlClient
  ...
  DynamicAliasReturn = T.type_alias{ T.nilable(String) }


  DynamicFieldType = T.type_alias{ T.nilable(String) }


  DynamicInputType = T.type_alias{ T.nilable(String) }


  DynamicReturnType = T.type_alias{ T.nilable(String) }
